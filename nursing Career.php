...
<head>
    ...
    <title>Amrita college of Nursing</title>
    <!-- Bootstrap core CSS -->
...
<div class="content-wrap">
	<div id="home" class="body-wrapper">
        ...
        <section id="Page-title" class="Page-title-Style9">
						...
						<div class="row">
							<div class="col-md-12 text-center">
								<div class="title-text">
									<h2 class="page-title">Nursing Career</h2>
								</div>
							</div>
							<div class="col-md-12 text-center">
        ...
        <section id="page-not-found" class="light-wrapper">
			<div class="container inner-page">
				<div class="row">
					<div class="section-404 col-lg-12">
						
						<p><b>Welcome to ACN. Meet your dreams of pursuing a rich and rewarding career in Nursing like Hospitals, clinics and medical Centers , Physicians ‘ offices and mental health agencies , Educational institution ,Large corporations , Extended care facilities , Nursing home , Rehabiliation centers , Hospices , Public and private schools , Daycare centers , mental health facilities , State and local health departments.
</b></p>
						<a href="index.php" class="btn blue">Back To Homepage</a>    
					</div>
				</div>
			</div>
		</section>
...
<div id="myModal" class="modal fade" role="dialog">
  ...
  <label for="sel1">Subject of Enquiry</label>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="txtMobile" name="txtMobile" placeholder="Enter 10 digit Mobile">
  </div>
   <div class="form-group">
  <label for="comment">Message:</label>
  <textarea class="form-control" rows="5" id="txtMessage" placeholder="Enter 120 Characters Only"></textarea>
</div>
