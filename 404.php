						...
						<div class="row">
							<div class="col-md-12 text-center">
								<div class="title-text">
									<h2 class="page-title">Page Under Construction</h2>
								</div>
							</div>
							<div class="col-md-12 text-center">
			...
			<div class="container inner-page">
				<div class="row">
					<div class="col-lg-12">
						   ...
						   <div class="row">
                                <div class="col-sm-4">
                                <img src="style/images/customer/vision.jpg" class="img-responsive"> </div>
                                <div class="col-sm-8 text-justify"> 
                                
                                <h3>Vision</h3>
                                <p>
                                To build in each student a strong character and the will power to excel globally.
                                </p>
