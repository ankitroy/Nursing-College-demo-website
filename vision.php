...
<div class="content-wrap">
			...
			<div class="container inner-page">
				<div class="row">
					<div class="section-404 col-lg-12">
						...
						<p><b>To build in each student a strong character and the will power to excel globally.
</b></p>
   ...
   <div class="row" >
    <div class="col-sm-4" style="background-color:#ffffff;">
    	<img src="style/images/customer/vision.jpg">
    </div>
    <div class="col-sm-8" style="background-color: transparent;"> <h1>Vision</h1>
  <div class="well">To build in each student a strong character and the will power to excel globally.</div>
  </div>
</div>
